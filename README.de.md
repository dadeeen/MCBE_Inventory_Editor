...
Das Quellrepository enthält außerdem optionale [Prüfungen mit der echten Bedrock-Engine](https://github.com/dadeeen/MCBE_Inventory_Editor/blob/main/docs/engine-checks.md). Diese Entwicklerwerkzeuge messen Itemgrenzen und prüfen ausgewählte NBT-Speicher- und Ladeabläufe mit einer ausdrücklich gewählten Serverversion. Mojangs Serverprogramme und erzeugte Testwelten werden nicht verteilt; die Werkzeuge sind von den App-Runtime-Paketen ausgeschlossen.
